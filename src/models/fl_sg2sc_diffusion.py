...
class Flsg2ScDiffusion(nn.Module):
    def __init__(self,
        ...
        # TODO: make these parameters configurable
        self.network = Flsg2ScTransformerDiffusionWrapper(
...
class Flsg2ScTransformerDiffusionWrapper(nn.Module):
    def __init__(self,
